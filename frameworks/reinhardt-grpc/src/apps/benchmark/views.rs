...
use crate::benchmark::benchmark_service_server::{BenchmarkService, BenchmarkServiceServer};
...
pub fn configured_service() -> BenchmarkServiceServer<BenchmarkServiceImpl> {
